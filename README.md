...
<table align="center">
  <tr>
    ...
    <td align="center" valign="top" width="33%">
      ...
      <br/>
      <sub>Team project: MLP trained on hand histories; integrates with CV + MCU subsystems for decision support during gameplay.</sub>
    </td>
  </tr>
  <tr>
    <td align="center" valign="top" width="33%">
    ...
    <td align="center" valign="top" width="33%">
      ...
      <br/>
      <sub>Multi-cycle design with six-state FSM; ALU, register file, memory, and branch/memory ops.</sub>
    </td>
    <td align="center" valign="top" width="33%">
      <a href="https://github.com/NAL1618/Head-Massager-Project">
        <img src="media/head_massager_cover.png" alt="Arduino Head Massager Project" width="250"><br/>
        <sub><b>Smart Head Massager</b></sub>
      </a>
      <br/>
      <sub>Hardware/software project combining Arduino control, CAD-designed mechanical components, and a Swift-based interface to coordinate the system.</sub>
    </td>
  </tr>
</table>
